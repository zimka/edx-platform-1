...
class CombinedOpenEndedFields(object):
    ...
    track_changes = Boolean(
        ...
        help="If set to 'True', peer graders will be able to make changes to the student submission and those changes will be tracked and showed along with the graded feedback.",
        default=False,
        scope=Scope.settings
    )
    due = Date(
