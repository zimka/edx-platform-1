...
try:
    from openedx.core.djangoapps.video_evms.mixin import VideoDescriptoEVMSMixin, EVMS_editor_saved_dec
except ImportError:
    VideoDescriptoEVMSMixin = object
try:
...
@XBlock.wants("settings")
class VideoDescriptor(VideoDescriptoEVMSMixin, VideoFields, VideoTranscriptsMixin, VideoStudioViewHandlers,
