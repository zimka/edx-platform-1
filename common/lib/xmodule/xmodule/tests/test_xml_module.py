...
from xmodule.modulestore.inheritance import InheritanceKeyValueStore, InheritanceMixin, InheritanceFieldData
...
class InheritanceFieldDataTest(unittest.TestCase):
    """Tests of InheritanceFieldData."""
    ...
    def setUp(self):
        ...
        self.field_data = InheritanceFieldData(
