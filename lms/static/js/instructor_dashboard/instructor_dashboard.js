        ...
        sectionsToInitialize = [
            {
                ...
                constructor: window.InstructorDashboard.sections.BanUser,
                $element: idashContent.find('.' + CSS_IDASH_SECTION + '#ban_user')
            }, {
            ...
            sectionsToInitialize = sectionsToInitialize.concat([
                {
                    ...
                    constructor: edx.instructor_dashboard.proctoring.ProctoredExamSuspiciousMonitorView,
                    $element: idashContent.find('.' + CSS_IDASH_SECTION + '#special_exams')
                }
            ]);
        }
